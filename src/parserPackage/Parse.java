...
//A lexical analyzer system and parser for simple expressions and assignment statements.
//Author: Christian Watts and Jakob Cravens
//Class: CSCI 4200-DB, Fall 2017 and CSCI 4200, Fall 2018
...
/********************************************************************/
	...
	//assign: Parses string according to:
	//<assign> -> id = <expr>
	static void assign(){
	...
	//expr: Parses string according to:
	//<expr> -> <term> {(+ | -) <term>}
	static void expr(){
		...
		//If next token is + or -, get next token and parse next term
	...
	//term: Parses string according to:
	//<term> -> <factor> {(* | /) <factor>}
	static void term(){
	...
	//factor: Parses string according to:
	...
	static void factor(){
		...
		if(nextToken == IDENT || nextToken == INT_LIT)
			...
			//If RHS is (<expr>), lex() passes over left paren and expr() looks for right paren
